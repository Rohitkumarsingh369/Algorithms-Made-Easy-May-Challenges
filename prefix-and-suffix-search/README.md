<h2>745. Prefix and Suffix Search</h2><h3>Hard</h3><hr><div><p>Design a special dictionary which has some words and allows you to search the words in it by a prefix and a suffix.</p>
